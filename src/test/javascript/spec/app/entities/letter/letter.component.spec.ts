...
import { LetterComponent } from 'app/entities/letter/letter.component';
    ...
    describe('Letter Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(LetterComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.letters[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
