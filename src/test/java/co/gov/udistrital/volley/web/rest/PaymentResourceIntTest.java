...
import co.gov.udistrital.volley.repository.PaymentRepository;
import co.gov.udistrital.volley.service.PaymentService;
...
public class PaymentResourceIntTest {
    ...
    private static final Long DEFAULT_PAYMENT_NUMBER = 1L;
    private static final Long UPDATED_PAYMENT_NUMBER = 2L;
    ...
    public void getAllPayments() throws Exception {
        ...
        restPaymentMockMvc.perform(get("/api/payments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].paymentNumber").value(hasItem(DEFAULT_PAYMENT_NUMBER.intValue())))
    ...
    public void getPayment() throws Exception {
        ...
        restPaymentMockMvc.perform(get("/api/payments/{id}", payment.getId()))
            ...
            .andExpect(jsonPath("$.paymentNumber").value(DEFAULT_PAYMENT_NUMBER.intValue()))
